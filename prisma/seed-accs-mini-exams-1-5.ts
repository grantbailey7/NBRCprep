  ...
  await prisma.miniExamQuestion.createMany({
    data: [
      ...
      },
      {
        ...
        questionIndex: 19,
        questionText:
          'A patient on venoarterial ECMO with femoral arterial return has SpO2 85% on the right hand and SpO2 99% on the right foot. What does this finding indicate?',
        choices: {
  ...
  await prisma.miniExamQuestion.createMany({
    data: [
      ...
      },
      {
        ...
        choices: {
          A: 'Increase P-high',
          B: 'Increase T-low to allow more time for exhalation',
        ...
        explanationWrong:
          'Increasing P-high may improve oxygenation but does not directly enhance CO2 removal. Increasing T-low would prolong the release phase but allow excessive derecruitment and is not recommended. Increasing P-low would reduce the pressure gradient during release, decreasing tidal volume and worsening CO2 elimination.',
        topic: 'Advanced Mechanical Ventilation',
      },
      {
        miniExamId: exam2.id,
  ...
  await prisma.miniExamQuestion.createMany({
    data: [
      ...
      },
      {
        ...
        choices: {
          A: 'Ineffective chest compressions generating poor cardiac output',
        ...
        explanationWrong:
          'The ETT was already confirmed in the trachea with an ETCO2 of 35 mmHg before the arrest, so esophageal placement is unlikely. A ventilator malfunction would not cause an ETCO2 drop coinciding with cardiac arrest. ROSC would be suggested by a sudden increase in ETCO2 to >40 mmHg, not a persistently low reading.',
        topic: 'Advanced Airway Management',
      },
      {
        miniExamId: exam5.id,
