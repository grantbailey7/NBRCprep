...
const PLAN_DESCRIPTIONS: Record<string, string> = {
  ...
  MONTHLY: 'Full TMC access - 100 flashcards, 5 mini exams, 3 full exams. Billed monthly.',
  FULL_ACCESS: 'Full TMC access - 100 flashcards, 5 mini exams, 3 full exams. Lifetime access.',
  FULL_BUNDLE: 'All 6 divisions - 600 flashcards, 30 mini exams, 18 full exams. Lifetime access.',
}
          ...
          {isFullAccess && (
            <div>
              ...
              <div className="card p-5 max-w-sm">
                ...
                <p className="text-xs text-brand-gray-500 mt-2">
                  Unlock all 6 divisions - 600 flashcards, 30 mini exams, 18 full exams.
                </p>
                <button
                  onClick={() => handleUpgrade('full_bundle')}
                  disabled={loading === 'full_bundle'}
