...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: 'article',
      siteName: 'NBRCprep',
      images: [`https://nbrcprep.app/api/og?title=${encodeURIComponent(page.title)}&type=cheat-sheet`],
    },
    twitter: {
...
export default async function CheatSheetPage({ params }: Props) {
  ...
  const pageSchema = {
    ...
    image: `https://nbrcprep.app/api/og?title=${encodeURIComponent(page.title)}&type=cheat-sheet`,
  }
