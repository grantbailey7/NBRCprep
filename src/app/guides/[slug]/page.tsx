...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://nbrcprep.app/guides/${page.slug}` },
    openGraph: {
      title: page.title,
      description: page.description,
...
export default async function GuidePage({ params }: Props) {
  ...
  const pageSchema = {
    ...
    image: `https://nbrcprep.app/api/og?title=${encodeURIComponent(page.title)}&type=guide`,
  }
  ...
  return (
    <>
      ...
      <SeoPageContent
        ...
        relatedContent={<RelatedResources currentSlug={page.slug} division={page.division} currentType="GUIDE" />}
      />
    </>
  )
}
